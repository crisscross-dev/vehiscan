...
<body class="m-0 p-0 overflow-hidden bg-guard-bg">
          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-guard-bg">
              ...
              <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden">
                ...
                <div class="p-4">
                  <button type="button" class="aspect-video bg-white dark:bg-slate-700 rounded-lg overflow-hidden mb-4 cursor-zoom-in focus:outline-none open-image-zoom-btn" data-image-target="carImage">
              ...
              <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden">
                ...
                <div class="p-4">
                  <button type="button" class="aspect-video bg-white dark:bg-slate-700 rounded-lg overflow-hidden mb-4 cursor-zoom-in focus:outline-none open-image-zoom-btn" data-image-target="ownerImage">
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-gray-200 dark:border-slate-700">
        ...
        <div class="bg-gray-50 dark:bg-slate-700/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button type="button" id="qrScannerModalCloseBtn" class="w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-slate-600 shadow-sm px-4 py-2 bg-white dark:bg-slate-800 text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
            Close
          </button>
        </div>
      </div>
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-gray-200 dark:border-slate-700">
        <div class="bg-white dark:bg-slate-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <form id="manual-log-form" class="mt-4 space-y-4">
                <div>
        ...
        <div class="bg-gray-50 dark:bg-slate-700/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
          ...
          <button type="button" id="manualLogModalCloseBtn" class="w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-slate-600 shadow-sm px-4 py-2 bg-white dark:bg-slate-800 text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
            Close
          </button>
        </div>
      </div>
  ...
  <div id="imageZoomModal" class="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center p-4 hidden" role="dialog" aria-modal="true" aria-label="Image zoom viewer" aria-hidden="true"
    style="z-index: var(--z-imagezoom);">
    <button type="button" id="imageZoomCloseBtn" class="absolute top-4 right-4 text-white text-4xl hover:text-gray-300 transition-colors">
      &times;
    </button>

        ...
        <div class="glass overflow-hidden hover:shadow-xl transition-all duration-300 animate-fade-in-up" style="animation-delay: ${delay}ms">
            ...
            <div class="p-5">
                ...
                <div class="flex gap-2 pt-2 border-t border-gray-100 dark:border-slate-700/50">
                    ${!isPrimary ? `
                        <button type="button" onclick="setPrimaryVehicle(${safeVehicleId})" class="flex-1 py-2 px-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2 text-sm font-semibold">
                    ...
                    ` : ''}
                    <button type="button" onclick="deleteVehicle(${safeVehicleId})" class="flex-1 py-2 px-3 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition-all flex items-center justify-center gap-2 text-sm font-semibold">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
